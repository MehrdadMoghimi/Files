...
def calculate_var_models(returns, weights, window_length, test_len, alpha, forecast_mean, forecast_std):
    ...
    var_models['Variance - Covariance'] = calculate_Var_Covar_VAR(returns, weights, window_length, test_len, alpha)
    ...
    var_models['E-GARCH'] = calculate_EGARCH_VAR(returns, weights, 2*window_length, test_len, alpha)
